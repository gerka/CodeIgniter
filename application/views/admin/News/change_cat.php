<script type="text/javascript">
                                                                      var NewsCatItem = "<?=$NewsCatItem['body']?>";
                                                                      var idCards = "<?=$NewsCatItem['id_cat']?>";
                                                                      var idElement = "<?=$NewsCatItem['id_element']?>";
                                                                  </script>  
<div class="row">
                        <div class="col-md-12">
                               ...
                               <form  class="form-horizontal form-row-seperated"  >
                                <div class="portlet">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-shopping-cart"></i>Редактирование категории № <?=$NewsCatItem['id_cat']?> </div>
                                                ...
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="h1" id="h1" placeholder="" value="<?=$NewsCatItem['h1']?>"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div name="summernote" id="summernote_1"> </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" name="preview_text" id="preview_text"><?=$NewsCatItem['preview_text']?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="alias" id="alias" placeholder="" disabled value="<?=$NewsCatItem['alias']?>"> </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane" id="tab_meta">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control maxlength-handler" name="title" id="title" maxlength="100" placeholder="" value="<?=$NewsCatItem['title']?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" id="meta_keywords" name="meta_keywords" maxlength="1000"><?=$NewsCatItem['meta_keywords']?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="description" id="description" maxlength="255"><?=$NewsCatItem['description']?></textarea>
