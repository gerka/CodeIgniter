                            ...
                            <div class="tab-pane active" id="tab_general">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="email" id="e-mail" placeholder="" value="<?=$userItem->email?>"> </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="username" id="username" readonly
                                                onfocus="this.removeAttribute('readonly')" value="<?=$userItem->username?>"> </div>
                                    </div>
                                    ...
                                    onfocus="this.removeAttribute('readonly')" class="form-control" name="password" id="password" placeholder=""> </div>
                                    </div>
                                    <!-- <div class="form-group">
                            ...
                            <div class="tab-pane" id="tab_meta">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control maxlength-handler" name="first_name" id="first_name" maxlength="100" placeholder="" value="<?=$userItem->first_name?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control maxlength-handler" name="last_name" id="last_name" maxlength="100" placeholder="" value="<?=$userItem->last_name?>">
                                            <span class="help-block"> max 100 chars </span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="tel" id="tel"  value="<?=$userItem->phone?>"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Компания:</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control maxlength-handler" name="company" id="company" maxlength="100" placeholder="" value="<?=$userItem->company?>">
                                            <span class="help-block"> max 100 chars </span>
                                        </div>
                                    </div>
                                </div>
