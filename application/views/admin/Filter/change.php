<script type="text/javascript">
  ...
  var idFilter = "<?=$filterItem['id_filter']?>";
  var idElement = "<?=$filterItem['id_element']?>"
</script> 
<div class="row">
                        <div class="col-md-12">
                            
                               <form  class="form-horizontal form-row-seperated" id="changeFilter" name="changeFilter">
                                <div class="portlet">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-shopping-cart"></i>Редактирование фильтра № <?=$filterItem['id_filter']?> </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Категории фильтров:
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-10">
                                                                <div class="form-control height-auto">
                                                                    <div class="scroller" style="height:275px;" data-always-visible="1">
                                                                        ...
                                                                        <?php foreach ($cards_cat_filter as $key => $value): ?>
                                                                                         ...
                                                                                         <li><label>
                                                                                       <input type="radio" name="filters" value="<?=$value['idfilter_cat']?>" <?=$retVal = (isset($filterItem['id_cat_filter'])and $filterItem['id_cat_filter'] == $value['idfilter_cat']) ? 'checked' :'' ?>>  <?=$value['h1'];?></label></li>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="alias" id="alias" placeholder="" disabled value="<?=$filterItem['alias']?>"> </div>
                                                        </div>
                                                         <div class="form-group ">
                                                            ...
                                                            <img id="image_logo" src="<?php if (isset($filterItem['logo']) and $filterItem['logo']!=null and $filterItem['logo'] !=''): ?> /images/<?=$filterItem['logo']?><?php endif ?>" alt="..." style="max-height: 150px;">
